...
<template>
	<form class="sharing">
		...
		<div v-show="settings.enabled" id="settings-sharing-api" class="sharing__section">
			...
			<NcCheckboxRadioSwitch type="switch"
				aria-describedby="settings-sharing-custom-disable-hint settings-sharing-custom-token-access-hint"
			...
			<div class="sharing__sub-section">
				<NcNoteCard id="settings-sharing-custom-disable-hint"
					class="sharing__note"
					type="info">
				...
				<NcNoteCard id="settings-sharing-custom-token-access-hint"
					class="sharing__note"
					type="warning">
					{{ t('settings', 'Shares with easily guessable tokens may be accessed easily') }}
				</NcNoteCard>
			</div>
